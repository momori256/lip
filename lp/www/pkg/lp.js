...
const ReplFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_repl_free(ptr >>> 0));
/**
*/
export class Repl {
    ...
    static __wrap(ptr) {
        ...
        obj.__wbg_ptr = ptr;
        ReplFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    */
    static eval(input) {
        ...
        try {
            ...
            wasm.repl_eval(retptr, ptr0, len0);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('lp_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
